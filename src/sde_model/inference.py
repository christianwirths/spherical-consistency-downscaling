...
class Inference:
    ...
    def run(self,
        ...
        elif all_samples.shape[-2] == 192:
            all_samples = all_samples[:,:,6:186,4:364] # remove padding
    ...
    def run_bridge(self,
        ...
        elif all_esm.shape[-2] == 192:
            all_esm = all_esm[:,:,6:186,4:364] # remove padding
            all_samples= all_samples[:,:,6:186,4:364] # remove padding
            all_conditions = all_conditions[:,:,6:186,4:364] # remove padding
    ...
    def convert_to_xarray(self,
        ...
        results = xr.Dataset(
            data_vars= { 'precipitation': (['time', 'latitude', 'longitude'], pr),
                    'temperature': (['time', 'latitude', 'longitude'], temp),
                    'total_cloud_cover': (['time', 'latitude', 'longitude'], tcc)    
                    },
            coords={
